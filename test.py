...
# Add this after your existing configuration code
...
# Predefined phishing emails - add this before your routes
predefined_emails = [
    {
        "id": 1,
...
# Function to generate AI emails - add this before your routes
...
# Function for AI to evaluate user's explanation - add this before your routes
...
# Add these models to test.py after the User model definition
